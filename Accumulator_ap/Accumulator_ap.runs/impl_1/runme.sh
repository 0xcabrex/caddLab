...
HD_PWD='D:/XILINX/vivado projects/Accumulator_ap/Accumulator_ap.runs/impl_1'
cd "$HD_PWD"
...
EAStep vivado -log Accumulator_ap.vdi -applog -m64 -product Vivado -messageDb vivado.pb -mode batch -source Accumulator_ap.tcl -notrace
