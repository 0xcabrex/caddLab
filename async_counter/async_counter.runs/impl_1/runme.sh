...
HD_PWD='C:/Users/asvam/vivado projects/async_counter_ap/async_counter_ap.runs/impl_1'
cd "$HD_PWD"
...
EAStep vivado -log ripple.vdi -applog -m64 -product Vivado -messageDb vivado.pb -mode batch -source ripple.tcl -notrace
