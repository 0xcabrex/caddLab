...
HD_PWD='D:/XILINX/vivado projects/Moore_Sequence_Detector/Moore_Sequence_Detector.runs/impl_1'
cd "$HD_PWD"
...
EAStep vivado -log moore_seq_det_ap.vdi -applog -m64 -product Vivado -messageDb vivado.pb -mode batch -source moore_seq_det_ap.tcl -notrace
