...
HD_PWD='C:/Users/asvam/vivado projects/encoder_8x1_priority/encoder_8x1_priority.runs/impl_1'
cd "$HD_PWD"
...
EAStep vivado -log encoder_8x1_priority.vdi -applog -m64 -product Vivado -messageDb vivado.pb -mode batch -source encoder_8x1_priority.tcl -notrace
