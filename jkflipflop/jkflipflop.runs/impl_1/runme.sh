...
HD_PWD='C:/Users/asvam/vivado projects/jkflipflop/jkflipflop.runs/impl_1'
cd "$HD_PWD"
...
EAStep vivado -log jkflipflop.vdi -applog -m64 -product Vivado -messageDb vivado.pb -mode batch -source jkflipflop.tcl -notrace
