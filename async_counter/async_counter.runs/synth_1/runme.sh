...
HD_PWD='C:/Users/asvam/vivado projects/async_counter_ap/async_counter_ap.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log ripple.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source ripple.tcl
