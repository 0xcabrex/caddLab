...
HD_PWD='C:/Users/asvam/vivado projects/synchronous_counter/synchronous_counter.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log synchronous_counter.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source synchronous_counter.tcl
