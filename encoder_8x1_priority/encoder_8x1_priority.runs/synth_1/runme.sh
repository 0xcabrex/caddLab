...
HD_PWD='C:/Users/asvam/vivado projects/encoder_8x1_priority/encoder_8x1_priority.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log encoder_8x1_priority.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source encoder_8x1_priority.tcl
