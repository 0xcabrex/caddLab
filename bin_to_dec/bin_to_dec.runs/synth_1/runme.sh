...
HD_PWD='C:/Users/asvam/vivado projects/bin_to_dec/bin_to_dec.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log bin_to_dec.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source bin_to_dec.tcl
