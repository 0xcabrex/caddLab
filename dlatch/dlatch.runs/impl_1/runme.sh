...
HD_PWD='C:/Users/asvam/vivado projects/dlatch/dlatch.runs/impl_1'
cd "$HD_PWD"
...
EAStep vivado -log dlatch.vdi -applog -m64 -product Vivado -messageDb vivado.pb -mode batch -source dlatch.tcl -notrace
