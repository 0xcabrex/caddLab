...
HD_PWD='C:/Users/asvam/vivado projects/Memory_Block/Memory_Block.runs/impl_1'
cd "$HD_PWD"
...
EAStep vivado -log memory_block.vdi -applog -m64 -product Vivado -messageDb vivado.pb -mode batch -source memory_block.tcl -notrace
