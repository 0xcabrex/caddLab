...
HD_PWD='D:/XILINX/vivado projects/Accumulator_ap/Accumulator_ap.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log Accumulator_ap.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source Accumulator_ap.tcl
