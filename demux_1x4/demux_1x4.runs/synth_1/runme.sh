...
HD_PWD='C:/Users/asvam/vivado projects/demux_1x4/demux_1x4.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log demux_1x4.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source demux_1x4.tcl
