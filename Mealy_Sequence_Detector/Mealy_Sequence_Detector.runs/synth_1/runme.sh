...
HD_PWD='D:/XILINX/vivado projects/Mealy_Sequence_Detector/Mealy_Sequence_Detector.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log mealy_seq_det_ap.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source mealy_seq_det_ap.tcl
