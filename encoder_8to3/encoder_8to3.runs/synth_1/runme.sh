...
HD_PWD='C:/Users/asvam/vivado projects/encoder_8to3/encoder_8to3.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log encoder_8to3.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source encoder_8to3.tcl
