...
HD_PWD='D:/XILINX/vivado projects/Array_Multiplier_ap/Array_Multiplier_ap.runs/impl_1'
cd "$HD_PWD"
...
EAStep vivado -log arr_mul_ap.vdi -applog -m64 -product Vivado -messageDb vivado.pb -mode batch -source arr_mul_ap.tcl -notrace
