...
HD_PWD='C:/Users/asvam/vivado projects/bin_to_dec/bin_to_dec.runs/impl_1'
cd "$HD_PWD"
...
EAStep vivado -log bin_to_dec.vdi -applog -m64 -product Vivado -messageDb vivado.pb -mode batch -source bin_to_dec.tcl -notrace
