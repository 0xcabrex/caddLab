...
HD_PWD='C:/Users/asvam/vivado projects/synchronous_counter/synchronous_counter.runs/impl_1'
cd "$HD_PWD"
...
EAStep vivado -log synchronous_counter.vdi -applog -m64 -product Vivado -messageDb vivado.pb -mode batch -source synchronous_counter.tcl -notrace
