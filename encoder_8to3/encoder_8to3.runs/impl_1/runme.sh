...
HD_PWD='C:/Users/asvam/vivado projects/encoder_8to3/encoder_8to3.runs/impl_1'
cd "$HD_PWD"
...
EAStep vivado -log encoder_8to3.vdi -applog -m64 -product Vivado -messageDb vivado.pb -mode batch -source encoder_8to3.tcl -notrace
