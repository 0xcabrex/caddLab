...
HD_PWD='D:/XILINX/vivado projects/Moore_Sequence_Detector/Moore_Sequence_Detector.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log moore_seq_det_ap.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source moore_seq_det_ap.tcl
